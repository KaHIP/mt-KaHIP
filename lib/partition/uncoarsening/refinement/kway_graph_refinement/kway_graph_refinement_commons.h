...
public:
        ...
        Gain compute_gain(graph_access& G,
                          NodeID& node,
...
#ifdef CPP11THREADS
        static std::unordered_map<std::thread::id, std::unique_ptr<kway_graph_refinement_commons>> m_instances;
#else
        static std::vector<kway_graph_refinement_commons*>* m_instances;
#endif
