...
typedef enum {
	...
	MATCHING_RANDOM_GPA,
        CLUSTER_COARSENING,
        MATCHING_SEQUENTIAL_LOCAL_MAX,
        MATCHING_PARALLEL_LOCAL_MAX
} MatchingType;
...
typedef enum {
	...
	STOP_RULE_STRONG,
        STOP_RULE_MEM,
        STOP_RULE_MULTIPLE_K_STRONG_CONTRACTION,
        STOP_RULE_MULTIPLE_K_WITH_MATCHING,
        STOP_RULE_MULTIPLE_K_STRONG_CONTRACTION_WITH_MATCHING
} StopRule;
